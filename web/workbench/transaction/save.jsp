...
String basePath = request.getScheme() + "://" + request.getServerName() + ":" +    request.getServerPort() + request.getContextPath() + "/";
	...
	//取得stage2possibility.properties文件解析的map
...
<script type="text/javascript" src="jquery/bs_typeahead/bootstrap3-typeahead.min.js"></script>
	...
	$(function (){
		...
		$("#create-transactionStage").change(function (){
			...
			//取得stage与possibility的对应关系,由于是从服务器中取得的，所以需要先在application域中取
			var json = {
			...
			//处理完json，接下来取可能性，对于动态的key，不能使用json.key的方式取得value，而使用json[key]
...
<body>
	...
	<form action="transaction/save.do" method="post" id="tranForm" class="form-horizontal" role="form" style="position: relative; top: -30px;">
		...
		<div class="form-group">
			...
			<div class="col-sm-10" style="width: 300px;">
				<input type="text" class="form-control" id="create-activitySrc" value="老柴快递">
				<input type="hidden" value="7c7431e14f844ad98418fe72dd7b827a" name="activityId">
			</div>
		</div>
		...
		<div class="form-group">
			...
			<div class="col-sm-10" style="width: 300px;">
				...
				<input type="hidden" value="2802504d792f45c3af7982f61a490926" name="contactsId">
			</div>
		</div>
