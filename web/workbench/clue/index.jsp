		...
		$("#saveBtn").click(function (){
			...
			$.ajax({
				...
				data : {
					...
					"owner" :$.trim($("#create-clueOwnerr").val()),
			...
			<div style="position: relative;top: 50px;">
				<table class="table table-hover">
					...
					<tbody>
						<tr>
							<td><input type="checkbox" /></td>
							<td><a style="text-decoration: none; cursor: pointer;" onclick="window.location.href='clue/detail.do?id=86d6bf099f1549229fb23c469ed4b5qe';">马云先生</a></td>
							<td>动力节点</td>
							<td>010-84846003</td>
							<td>12345678901</td>
							<td>广告</td>
