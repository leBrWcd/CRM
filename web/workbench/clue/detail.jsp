	...
	$(function(){
		...
		$("#bindBtn").click(function (){
			...
			if($xz.length==0){
				...
				//选择了一个或多个
				//我们关联市场活动，也就是说在tbl_clue_activity_relation中新增记录，表中的id用UUID，clueId就是当前页的id
				//而activityId就是复选框中的id，可能选择多个，那么就需要拼接参数
				//  url : clue/bind.do?cid=xxx&aid=xxx&aid=xxx
				var param = "cid=${c.id}";
				...
				$.ajax({
					...
					success : function (respData){
						if(respData.success){
							...
							//刷新关联的市场活动列表
							showActivityList();
							//清空搜索框中的信息 复选框中的✔，清空activitySearchBody中的内容
							$("#aname").val("");
